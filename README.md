...
[![My Skills](https://skillicons.dev/icons?i=html,css,js,bootstrap,tailwind,ts,angular,git,github,materialui,vscode,solidjs,webflow,figma,ai,nodejs,npm,postman,linux,ubuntu,bash,discord,obsidian,stackoverflow&perline=3)](https://skillicons.dev)
