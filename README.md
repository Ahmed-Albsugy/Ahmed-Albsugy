...
[![My Skills](https://skillicons.dev/icons?i=html,css,js,bootstrap,tailwind,ts,angular,git,github,vscode,solidjs,webflow,figma,ai,nodejs,npm,postman,linux,ubuntu,discord,obsidian)](https://skillicons.dev)
